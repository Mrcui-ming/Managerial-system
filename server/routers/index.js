...
function pageFilter(arr, pageNum, pageSize) {
  ...
  //通过 start和 end 计算出获取多少条数据
  //start指定 从数组第几个下标开始获取
  //你请求第一页的数据 很明显就是从0开始
  //你请求第二页数据 很明显就是从你要获取的条数 开始
  //规定：你每次请求的页可以不一样 但是你每次请求获取数据的个数必须一样
  // 根据这个规定，你请求第二页 所以肯定跳过了第一页的数据(第一页有多少条数据呢？ 按照规定请求个数必须一样，所以 第一页就有你请求第二页相同的获取个数)
